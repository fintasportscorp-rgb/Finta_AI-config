...
|-----------|-----------------|-------------------|
| Binary classification (pass/fail) | Recall, Precision, F1 | Cohen's ? |
| Ordinal scale (1-5 rating) | Spearman's ?, Kendall's t | Cohen's ? (weighted) |
...
³  ³   Criteria Loader   ³ ÄÄ Rubrics, weights    ³
³  ÀÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÙ                         ³
³             ³                                     ³
³                                                  ³
³  ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿                         ³
³  ³   Primary Scorer    ³ ÄÄ Direct or Pairwise  ³
³  ÀÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÙ                         ³
³             ³                                     ³
³                                                  ³
³  ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿                         ³
³  ³   Bias Mitigation   ³ ÄÄ Position swap, etc. ³
³  ÀÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÙ                         ³
³             ³                                     ³
³                                                  ³
³  ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿                         ³
³  ³ Confidence Scoring  ³ ÄÄ Calibration         ³
³  ÀÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÙ                         ³
³             ³                                     ³
³                                                  ³
...
ÃÄÄ Yes  Direct Scoring
³   ÀÄÄ Examples: factual accuracy, instruction following, format compliance
³
ÀÄÄ No  Is it a preference or quality judgment?
    ÃÄÄ Yes  Pairwise Comparison
    ³   ÀÄÄ Examples: tone, style, persuasiveness, creativity
    ³
    ÀÄÄ No  Consider reference-based evaluation
        ÀÄÄ Examples: summarization (compare to source), translation (compare to reference)
```
...
are correctly described.",
  "improvement": "Could add the specific tilt angle (23.5ø) for completeness."
}
```
