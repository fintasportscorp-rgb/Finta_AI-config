...
```
marketing-skill/
ÃÄÄ marketing-context/      Foundation: brand voice, audience, goals
ÃÄÄ marketing-ops/          Router: dispatches to the right skill
³
ÃÄÄ Content Pod (8)         Strategy  Production  Editing  Social
ÃÄÄ SEO Pod (5)             Traditional + AI SEO + Schema + Architecture
ÃÄÄ CRO Pod (6)             Pages, Forms, Signup, Onboarding, Popups, Paywall
ÃÄÄ Channels Pod (5)        Email, Ads, Cold Email, Ad Creative, Social Mgmt
ÃÄÄ Growth Pod (4)          A/B Testing, Referrals, Free Tools, Churn
ÃÄÄ Intelligence Pod (4)    Competitors, Psychology, Analytics, Campaigns
ÀÄÄ Sales & GTM Pod (2)     Pricing, Launch Strategy
```
