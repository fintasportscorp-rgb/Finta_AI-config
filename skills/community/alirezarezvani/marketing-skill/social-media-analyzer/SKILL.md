...
```
Engagement Rate = (Likes + Comments + Shares + Saves) / Reach ž 100
```
...
|--------|---------|----------------|
| Engagement Rate | Engagements / Reach ž 100 | Audience interaction level |
| CTR | Clicks / Impressions ž 100 | Content click appeal |
| Reach Rate | Reach / Followers ž 100 | Content distribution |
| Virality Rate | Shares / Impressions ž 100 | Share-worthiness |
| Save Rate | Saves / Reach ž 100 | Content value |
...
6. **Validation:** ROI = (Value - Spend) / Spend ž 100
...
| Cost Per Thousand (CPM) | (Spend / Impressions) ž 1000 |
