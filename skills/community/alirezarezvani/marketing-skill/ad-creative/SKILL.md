...
|----------|--------|---------------|-----------------|-------|
| Google RSA | Search | 30 chars (ž15) | 90 chars (ž4 descriptions) | Max 3 pinned |
| Google Display | Display | 30 chars (ž5) | 90 chars (ž5) | Also needs 5 images |
...
| "Create a creative matrix" | Table: angles ž platforms with full copy per cell |
