...
project/
ÃÄÄ specs/
³   ÃÄÄ user-auth.md          # Feature spec with acceptance criteria
³   ÃÄÄ payment-processing.md
³   ÀÄÄ notification-system.md
ÃÄÄ tests/
³   ÃÄÄ test_user_auth.py     # Tests derived from specs/user-auth.md
³   ÃÄÄ test_payments.py
³   ÀÄÄ test_notifications.py
ÀÄÄ src/
```
