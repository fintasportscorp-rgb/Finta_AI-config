...
Structure analysis:
  V controllers/  - Presentation layer detected
  V services/     - Business logic layer detected
  V repositories/ - Data access layer detected
...
|----------------|---------------|-----------------|
| Structured with relationships | V | |
| ACID transactions required | V | |
| Flexible/evolving schema | | V |
| Document-oriented data | | V |
| Time-series data | | V (specialized) |
