...
**Exit Codes:** `0` = no critical/high findings ú `1` = high severity findings ú `2` = critical severity findings
...
**Exit Codes:** `0` = no critical/high vulnerabilities ú `1` = high severity vulnerabilities ú `2` = critical severity vulnerabilities
...
**Exit Codes:** `0` = compliant (90%+ score) ú `1` = non-compliant (50-69% score) ú `2` = critical gaps (<50% score)
