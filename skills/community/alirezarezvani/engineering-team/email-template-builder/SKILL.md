...
ÃÄÄ components/
³   ÃÄÄ layout/
³   ³   ÃÄÄ email-layout.tsx       # Base layout with brand header/footer
³   ³   ÀÄÄ email-button.tsx       # CTA button component
³   ÃÄÄ partials/
³   ³   ÃÄÄ header.tsx
³   ³   ÀÄÄ footer.tsx
ÃÄÄ templates/
³   ÃÄÄ welcome.tsx
³   ÃÄÄ verify-email.tsx
³   ÃÄÄ password-reset.tsx
³   ÃÄÄ invoice.tsx
³   ÃÄÄ notification.tsx
³   ÀÄÄ weekly-digest.tsx
ÃÄÄ lib/
³   ÃÄÄ send.ts                    # Unified send function
³   ÃÄÄ providers/
³   ³   ÃÄÄ resend.ts
³   ³   ÃÄÄ postmark.ts
³   ³   ÀÄÄ ses.ts
³   ÀÄÄ tracking.ts                # UTM + analytics
ÃÄÄ i18n/
³   ÃÄÄ en.ts
³   ÀÄÄ de.ts
ÀÄÄ preview/                       # Dev preview server
    ÀÄÄ server.ts
```
        ...
        <Container className="email-container" style={styles.container}>
          ...
          <Section style={styles.footer}>
            <Text style={styles.footerText}>
              MyApp Inc. ú 123 Main St ú San Francisco, CA 94105
            </Text>
            <Text style={styles.footerText}>
