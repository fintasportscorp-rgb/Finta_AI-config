...
my-app/
ÃÄÄ app/
³   ÃÄÄ layout.tsx        # Root layout with fonts
³   ÃÄÄ page.tsx          # Home page
³   ÃÄÄ globals.css       # Tailwind + CSS variables
³   ÀÄÄ api/health/route.ts
ÃÄÄ components/
³   ÃÄÄ ui/               # Button, Input, Card
³   ÀÄÄ layout/           # Header, Footer, Sidebar
ÃÄÄ hooks/                # useDebounce, useLocalStorage
ÃÄÄ lib/                  # utils (cn), constants
ÃÄÄ types/                # TypeScript interfaces
