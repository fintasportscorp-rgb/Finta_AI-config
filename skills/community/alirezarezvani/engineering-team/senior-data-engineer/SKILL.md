...
ÃÄÄ Yes  Use streaming
³   ÀÄÄ Is exactly-once semantics needed?
³       ÃÄÄ Yes  Kafka + Flink/Spark Structured Streaming
³       ÀÄÄ No  Kafka + consumer groups
ÀÄÄ No  Use batch
    ÀÄÄ Is data volume > 1TB daily?
        ÃÄÄ Yes  Spark/Databricks
        ÀÄÄ No  dbt + warehouse compute
```
