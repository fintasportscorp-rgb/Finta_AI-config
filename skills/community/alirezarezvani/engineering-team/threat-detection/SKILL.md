...
|--------|--------|-------------|
| Actor relevance | ž3 | How closely does this TTP match known threat actors in your sector? |
| Control gap | ž2 | How many of your existing controls would miss this behavior? |
| Data availability | ž1 | Do you have the telemetry data needed to test this hypothesis? |

Priority score = (actor_relevance ž 3) + (control_gap ž 2) + (data_availability ž 1)
...
| Beaconing C2 via jitter-heavy intervals | T1071.001 | Proxy logs, DNS logs | Regular interval outbound connections ñ10% jitter |
