...
```
external
  юд T1566.001 (spearphishing)  initial_access
       юд T1059.001 (PowerShell)  execution
            юд T1003.001 (LSASS dump)  credential_access [CHOKE POINT]
                 юд T1550.002 (Pass-the-Hash)  lateral_movement
                      юд T1078.002 (domain account)  privilege_escalation
                           юд Crown Jewel: Domain Controller
```
