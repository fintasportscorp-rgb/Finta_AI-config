...
- **No pipeline-coverage check.** Industry rule of thumb: forecast > pipeline ö 3 is anti-pattern. The tool surfaces the ratio; respect it.
...
2. **"What's your pipeline coverage ratio, and is your commit above pipeline ö 3?"**
