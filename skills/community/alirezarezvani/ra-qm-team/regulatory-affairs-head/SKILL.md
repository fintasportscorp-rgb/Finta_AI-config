...
|----------------|---------------------|----------------|-------|-------|
| Intended use | Wound measurement | Wound measurement | V | Identical |
| Technology | 2D camera | 2D + AI analysis | ? | New TC; address below |
| Energy type | Non-energized | Non-energized | V | |
| Patient contact | No | No | V | |
| SE conclusion | New TC does not raise new safety/effectiveness questions; bench data demonstrates equivalent accuracy (ñ2mm vs ñ3mm predicate) |
...
4. Compile Technical Documentation per Annex II checklist:
   - [ ] Annex II õ1: Device description, intended purpose, UDI
   - [ ] Annex II õ2: Design and manufacturing information (drawings, BoM, process flows)
   - [ ] Annex II õ3: GSPR checklist - each requirement mapped to evidence (standard, test report, or justification)
   - [ ] Annex II õ4: Benefit-risk analysis and risk management file (ISO 14971)
   - [ ] Annex II õ5: Product verification and validation (test reports)
   - [ ] Annex II õ6: Post-market surveillance plan
...
|----------|-------------|---------------------|-------------------|--------|
| Annex I õ1 | Safe design and manufacture | ISO 14971:2019 | Risk Management File v2.1 | Complete |
| Annex I õ11.1 | Devices with measuring function ñaccuracy | EN ISO 15223-1 | Performance Test Report PT-003 | Complete |
| Annex I õ17 | Cybersecurity | MDCG 2019-16 | Cybersecurity Assessment CS-001 | In progress |
...
| New Intended Use | V | |
| Complex Testing | V | |
| Uncertain Predicate | V | |
| Clinical Data Needed | V | |
| Well-established | | V |
| Clear Predicate | | V |
| Standard Testing | | V |
...
ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿
³ Product          ³ Market   ³ Type       ³ Target Date ³ Status   ³
ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄ´
...
ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÙ
...
|-----|--------|-------------|
| First-time approval rate | >85% | (Approved without major deficiency / Total submitted) ž 100 |
| On-time submission | >90% | (Submitted by target date / Total submissions) ž 100 |
| Review cycle compliance | >95% | (Responses within deadline / Total requests) ž 100 |
| Regulatory hold time | <20% | (Days on hold / Total review days) ž 100 |
