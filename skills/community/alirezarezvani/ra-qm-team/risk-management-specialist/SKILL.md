...
|-------|------|-------------|-----------|
| P5 | Frequent | Expected to occur | >10?ü |
| P4 | Probable | Likely to occur | 10?ü to 10?4 |
| P3 | Occasional | May occur | 10?4 to 10?5 |
| P2 | Remote | Unlikely | 10?5 to 10?6 |
| P1 | Improbable | Very unlikely | <10?6 |
...
1. Calculate initial risk level from probability ž severity
...
Apply Acceptability Criteria
      ³
      ÃÄÄ Low Risk ÄÄÄÄÄÄÄÄÄÄ Accept and document
      ³
      ÃÄÄ Medium Risk ÄÄÄÄÄÄÄ Consider risk reduction
      ³   ³                    Document ALARP if not reduced
      ³   
      ³   Practicable to reduce?
      ³   ³
      ³   YesÄÄ Implement control
      ³   NoÄÄÄ Document ALARP rationale
      ³
      ÃÄÄ High Risk ÄÄÄÄÄÄÄÄÄ Risk reduction required
      ³   ³                    Must demonstrate ALARP
      ³   
      ³   Implement control
      ³   Verify residual risk
      ³
      ÀÄÄ Unacceptable ÄÄÄÄÄÄ Design change mandatory
...
What is the risk level?
        ³
        ÃÄÄ Unacceptable ÄÄ Can hazard be eliminated?
        ³                    ³
        ³                YesÄÁÄNo
        ³                 ³     ³
        ³                      
        ...
        ³                   protection + training
        ³
        ÀÄÄ High/Medium ÄÄ Apply hierarchy
                            starting at Level 1
```
