...
ÃÄÄ Yes  Use FAULT TREE ANALYSIS
ÀÄÄ No  Is human error the suspected primary cause?
    ÃÄÄ Yes  Use HUMAN FACTORS ANALYSIS
    ÀÄÄ No  How many potential contributing factors?
        ÃÄÄ 1-2 factors (linear causation)  Use 5 WHY ANALYSIS
        ÃÄÄ 3-6 factors (complex, systemic)  Use FISHBONE DIAGRAM
        ÀÄÄ Unknown/proactive assessment  Use FMEA
```
...
ÃÄÄ Yes  CAPA INEFFECTIVE (re-investigate root cause)
ÀÄÄ No  Were all effectiveness criteria met?
    ÃÄÄ Yes  CAPA EFFECTIVE (proceed to closure)
    ÀÄÄ No  Extent of gap?
        ÃÄÄ Minor gap  Extend verification or accept with justification
        ÀÄÄ Significant gap  CAPA INEFFECTIVE (revise actions)
```
