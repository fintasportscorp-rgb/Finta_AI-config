...
|----------|-----|--------|-------------|
| Process | First Pass Yield | >95% | (Units passed first time / Total units) ž 100 |
| Process | Nonconformance Rate | <1% | (NC count / Total units) ž 100 |
| CAPA | CAPA Closure Rate | >90% | (On-time closures / Due closures) ž 100 |
| CAPA | CAPA Effectiveness | >85% | (Effective CAPAs / Verified CAPAs) ž 100 |
| Audit | Finding Closure Rate | >90% | (On-time closures / Due closures) ž 100 |
| Audit | Repeat Finding Rate | <10% | (Repeat findings / Total findings) ž 100 |
| Customer | Complaint Rate | <0.1% | (Complaints / Units sold) ž 100 |
