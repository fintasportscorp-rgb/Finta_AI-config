...
- DPO appointment threshold (õ 38 BDSG - 20+ employees)
- Employment data processing (õ 26 BDSG)
- Video surveillance rules (õ 4 BDSG)
- Credit scoring requirements (õ 31 BDSG)
...
Step 2: If employees involved, review õ 26 BDSG
         Document legal basis for employee data
         Check works council requirements

Step 3: If video surveillance, comply with õ 4 BDSG
         Install signage
         Document necessity
         Limit retention
...
|-------|--------------|-----------------|
| DPO threshold | õ 38 | 20+ employees = mandatory DPO |
| Employment | õ 26 | Detailed employee data rules |
| Video | õ 4 | Signage and proportionality |
| Scoring | õ 31 | Explainable algorithms |
