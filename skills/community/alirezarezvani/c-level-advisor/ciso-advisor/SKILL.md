...
**Formula:** `ALE = SLE ž ARO` (Single Loss Expectancy ž Annual Rate of Occurrence). Board language: "This risk has $X expected annual loss. Mitigation costs $Y."
...
Evaluate every decision through probability ž impact. Quantify risks in business terms (dollars, not severity labels). Prioritize by expected annual loss.
