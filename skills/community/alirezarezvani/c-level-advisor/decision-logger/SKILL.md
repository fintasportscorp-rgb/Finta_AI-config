...
ÃÄÄ decisions.md       # Layer 2: append-only, founder-approved
ÃÄÄ YYYY-MM-DD-raw.md  # Layer 1: full transcript per meeting
ÀÄÄ archive/YYYY/      # Raw files after 90 days
```
