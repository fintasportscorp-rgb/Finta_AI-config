...
```
docs/TC/
ÃÄÄ tc_config.json          # Project settings
ÃÄÄ tc_registry.json        # Master index + statistics
ÃÄÄ records/
³   ÀÄÄ TC-001-04-05-26-user-auth/
³       ÀÄÄ tc_record.json  # Source of truth
ÀÄÄ evidence/
    ÀÄÄ TC-001/             # Log snippets, command output, screenshots
```
