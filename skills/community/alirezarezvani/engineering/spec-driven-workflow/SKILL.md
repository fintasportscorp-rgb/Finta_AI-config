...
컴컴컴컴컴컴컴컴컴컴�         컴컴컴컴컴컴컴컴컴컴컴컴컴
Phase 1: Gather Requirements
Phase 2: Write Spec
Phase 3: Validate Spec
Phase 4: Generate Tests  컴  RED: Tests exist and fail
Phase 5: Implement       컴  GREEN: Minimal code to pass
Phase 6: Self-Review     컴  REFACTOR: Clean up internals
```
