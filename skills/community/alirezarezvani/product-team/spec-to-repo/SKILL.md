...
ÃÄÄ .env.example
ÃÄÄ .gitignore
ÃÄÄ .github/workflows/ci.yml
ÃÄÄ package.json / requirements.txt / go.mod
ÃÄÄ src/
³   ÃÄÄ ...
ÃÄÄ tests/
³   ÃÄÄ ...
...
task-api/
ÃÄÄ README.md
ÃÄÄ .env.example              # API_KEY, DATABASE_URL
ÃÄÄ .gitignore
ÃÄÄ .github/workflows/ci.yml
ÃÄÄ requirements.txt          # fastapi, uvicorn, sqlalchemy, pytest
ÃÄÄ main.py                   # FastAPI app, CORS, lifespan
ÃÄÄ models.py                 # SQLAlchemy Task model
ÃÄÄ schemas.py                # Pydantic request/response schemas
ÃÄÄ database.py               # SQLite engine + session
ÃÄÄ auth.py                   # API key middleware
ÃÄÄ routers/
³   ÀÄÄ tasks.py              # CRUD endpoints
ÀÄÄ tests/
    ÀÄÄ test_tasks.py         # Smoke tests for each endpoint
```
...
recipe-share/
ÃÄÄ README.md
ÃÄÄ .env.example              # DATABASE_URL, NEXTAUTH_SECRET, NEXTAUTH_URL
ÃÄÄ .gitignore
ÃÄÄ .github/workflows/ci.yml
ÃÄÄ package.json              # next, react, tailwindcss, prisma, next-auth
ÃÄÄ tailwind.config.ts
ÃÄÄ tsconfig.json
ÃÄÄ next.config.ts
ÃÄÄ prisma/
³   ÀÄÄ schema.prisma         # User, Recipe, Ingredient, Favorite models
ÃÄÄ src/
³   ÃÄÄ app/
³   ³   ÃÄÄ layout.tsx
³   ³   ÃÄÄ page.tsx          # Homepage - recipe feed
³   ³   ÃÄÄ recipes/
³   ³   ³   ÃÄÄ page.tsx      # Browse recipes
³   ³   ³   ÃÄÄ [id]/page.tsx # Recipe detail
³   ³   ³   ÀÄÄ new/page.tsx  # Create recipe form
³   ³   ÀÄÄ api/
³   ³       ÃÄÄ auth/[...nextauth]/route.ts
³   ³       ÀÄÄ recipes/route.ts
³   ÃÄÄ components/
³   ³   ÃÄÄ RecipeCard.tsx
³   ³   ÃÄÄ RecipeForm.tsx
³   ³   ÀÄÄ Navbar.tsx
...
³   ÀÄÄ expense_tracker/
³       ÃÄÄ __init__.py
³       ÃÄÄ cli.py            # argparse commands
³       ÃÄÄ database.py       # SQLite operations
³       ÃÄÄ models.py         # Expense dataclass
³       ÀÄÄ formatters.py     # Table + CSV output
ÀÄÄ tests/
    ÀÄÄ test_cli.py
```
