...
³   ÃÄÄ (auth)/
³   ³   ÃÄÄ login/page.tsx
³   ³   ÃÄÄ register/page.tsx
³   ³   ÀÄÄ layout.tsx
³   ÃÄÄ (dashboard)/
³   ³   ÃÄÄ dashboard/page.tsx
³   ³   ÃÄÄ settings/page.tsx
³   ³   ÃÄÄ billing/page.tsx
³   ³   ÀÄÄ layout.tsx
³   ÃÄÄ (marketing)/
³   ³   ÃÄÄ page.tsx
³   ³   ÃÄÄ pricing/page.tsx
³   ³   ÀÄÄ layout.tsx
³   ÃÄÄ api/
³   ³   ÃÄÄ auth/[...nextauth]/route.ts
³   ³   ÃÄÄ webhooks/stripe/route.ts
³   ³   ÃÄÄ billing/checkout/route.ts
³   ³   ÀÄÄ billing/portal/route.ts
³   ÀÄÄ layout.tsx
ÃÄÄ components/
³   ÃÄÄ ui/
³   ÃÄÄ auth/
³   ³   ÃÄÄ login-form.tsx
³   ³   ÀÄÄ register-form.tsx
³   ÃÄÄ dashboard/
³   ³   ÃÄÄ sidebar.tsx
³   ³   ÃÄÄ header.tsx
³   ³   ÀÄÄ stats-card.tsx
...
³   ÀÄÄ migrations/
ÃÄÄ hooks/
³   ÃÄÄ use-subscription.ts
³   ÀÄÄ use-user.ts
ÃÄÄ types/index.ts
ÃÄÄ middleware.ts
ÃÄÄ .env.example
ÃÄÄ drizzle.config.ts
ÀÄÄ next.config.ts
```
