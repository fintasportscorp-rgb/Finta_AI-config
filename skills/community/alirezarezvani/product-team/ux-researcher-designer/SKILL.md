...
4. **Fill in layers for each stage**
   ...
   ```
   Stage: [Name]
   ÃÄÄ Actions: What does user do?
   ÃÄÄ Touchpoints: Where do they interact?
   ÃÄÄ Emotions: How do they feel? (1-5)
   ÃÄÄ Pain Points: What frustrates them?
   ÀÄÄ Opportunities: Where can we improve?
   ```

5. **Identify opportunities**

   Priority Score = Frequency ž Severity ž Solvability
